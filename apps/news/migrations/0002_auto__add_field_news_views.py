...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.views'
        db.add_column('news_news', 'views',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.views'
        db.delete_column('news_news', 'views')
    ...
    models = {
        ...
        'news.news': {
            'Meta': {'ordering': "['-created_at']", 'object_name': 'News'},
